    ...
    class Quadtree_sec
    {
        ...
        */
        ...
        private void Split()
        {
            ...
            nodes[0] = new Quadtree_sec(level + 1, new CollisionBox(x + subWidth, y, subWidth, subHeight));
            nodes[1] = new Quadtree_sec(level + 1, new CollisionBox(x, y, subWidth, subHeight));
            nodes[2] = new Quadtree_sec(level + 1, new CollisionBox(x, y + subHeight, subWidth, subHeight));
            nodes[3] = new Quadtree_sec(level + 1, new CollisionBox(x + subWidth, y + subHeight, subWidth, subHeight));
        }
        ...
        */
        public void Insert(Sprite nsprite)
        {
            if (nodes[0] != null)
            {
        ...
        */
        public List<Sprite> retrieve(List<Sprite> returnObjects, Sprite mainSprite)
        {
